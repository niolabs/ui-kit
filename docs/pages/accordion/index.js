...
import { Accordion, AccordionItem } from '../../../src/accordion/index';
  ...
  render() {
    ...
    return (
      <div>
        <h1>Accordian</h1>
        <p>
          Collapsible containers designed to help you reveal essential content and preserve space, reducing visual complexity.
        </p>
        <hr />
