  ...
  render() {
    ...
    return (
      <div>
        <h1>Accordian</h1>
        <p>
          Collapsible containers designed to help you preserve space, reducing visual complexity.
        </p>
        <hr />
        <h2>Basics</h2>
        <p>Importing the Accordion component:</p>
        <pre>
          <code>
            {
`// Import with local scoped class names (via CSS Modules)
import { Accordian } from '@nio/ui-kit/lib/components/accordian';`
            }
          </code>
        </pre>
        <pre>
