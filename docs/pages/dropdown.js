...
import { Dropdown, LinkWithDropdown } from '../../src/components/dropdown/index';
...
const DropdownPage = () => (
  <div>
    ...
    <LinkWithDropdown
      dropdownContent={
        <div>
          <label htmlFor="text1">Name<input id="text1" placeholder="Kirk, James T." type="text" /></label>
          <br />
          <label htmlFor="text2">Rank<input id="text2" placeholder="Captain" type="text" /></label>
        </div>
      }
    >
    ...
    <LinkWithDropdown
      ...
      triggerFocus
    >
      <Button dropdown tabIndex="0">Focusable Dropdown</Button>
    </LinkWithDropdown>
    <br />
    <LinkWithDropdown
      closeOnClickOutside
